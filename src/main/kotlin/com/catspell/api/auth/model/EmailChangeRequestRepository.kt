...
interface EmailChangeRequestRepository : JpaRepository<EmailChangeRequest, UUID> {
    fun findByTokenHash(tokenHash: String): EmailChangeRequest?
    fun findAllByUserAndUsedAtIsNull(user: User): List<EmailChangeRequest>
