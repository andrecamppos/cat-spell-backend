...
- [ ] **MOD-01**: A user can block another user
- [ ] **MOD-02**: A block is enforced bidirectionally on every surface — discovery feed, profile/owner detail, chat send, and match lookup (neither party sees or can contact the other)
...
- [ ] **MOD-05**: A user can unmatch another user, ending the match/conversation without banning rediscovery (the other user can reappear in the feed)
