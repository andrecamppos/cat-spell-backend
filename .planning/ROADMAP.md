...
- [x] 12-02-PLAN.md — EmailChangeEmailRenderer + app.confirm-email-change-url config + InvalidCurrentPasswordException(403 INVALID_CURRENT_PASSWORD) handler (ACCT-01, ACCT-03) [Wave 1]
